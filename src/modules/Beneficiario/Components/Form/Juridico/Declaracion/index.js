    ...
    <>
      ...
      <Grid item xs={12}>
        <>
          ...
          <Typography align="justify">
            El solicitante garantiza que se ha informado a los titulares sobre
            el ejercicio de sus derechos contemplados en la Ley Orgánica de
            Protección de Datos Personales, incluyendo la revocación del
            consentimiento, mediante una solicitud dirigida a{' '}
            <b>datosprotegidos@generali.com.ec</b> o en cualquiera de las
            oficinas de la compañía. Generali Ecuador Compañía de Seguros S.A
            garantiza su compromiso de tratar los datos personales conforme a la
            normativa ecuatoriana, adoptando las medidas de seguridad
            necesarias, y asegurando de manera irrestricta la confidencialidad y
