...
import { validationSchema } from '@modules/Beneficiario/Validator/Juridico/PasoTres'
import { yupResolver } from '@hookform/resolvers/yup'
import Grid from '@mui/material/Grid'
// COMPONENTES
import Documentos from '@modules/Beneficiario/Components/Form/Juridico/Documentos'
import Declaracion from '@modules/Beneficiario/Components/Form/Juridico/Declaracion'
import Revision from '@modules/Beneficiario/Components/Form/Juridico/Revision'
    ...
    try {
      ...
      if (_activeStep !== _steeps.length) {
        ...
        const { data } = await axiosPrivate.post(
          `beneficiario-juridico/declaracion/${_hash}`,
          param,
        )
        //
        if (data) {
