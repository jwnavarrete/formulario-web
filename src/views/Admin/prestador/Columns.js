...
const columns = [
  {
    ...
    renderCell: cellValues => {
      return <ListAction row={cellValues.row} contexto={PrestadorAPPContext} options={options} tipo='prestador' />
    }
  },
  { field: "identificacion", headerName: "Identificación", width: 150 },
  { field: "correo_prestador", headerName: "Correo Prestador", width: 200 },
  ...
  },
  {
    ...
    cellClassName: 'actions',
    renderCell: cellValues => {
      const { handleRowClick } = useContext(PrestadorAPPContext); //
      return (
        <>
          <Button
            color={"primary"}
