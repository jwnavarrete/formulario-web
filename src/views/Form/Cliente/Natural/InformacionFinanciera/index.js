...
const index = () => {
  ...
  useEffect(() => {
    ...
    if(actividad?.sector_uno_info){
      setValue('sector_uno_info',actividad.sector_uno_info)
      getCatalogo(`actividadeco/${actividad.sector_uno_info}`, setCatalogoActividadEco);
    }
    if(actividad?.actividad_info){
      setValue('actividad_info',actividad.actividad_info)
    }
    ...
    <>
      ...
      {infFinanciera.otrosIngresos && (
        <>
          ...
          <Grid item xs={12} md={6} lg={3}>
            <SelectOption name="actividad_info" label="Actividad económica">
