...
const index = () => {
    const { handleDependInput ,getDisableByName,formData} = useContext(NaturalContext)
    ...
    useEffect(() =>{
        ...
        hangleTipoPago(cuestionario?.tipo_cuenta_pago)
    ...
    return(
        <>
            ...
            <Grid item xs={12} md={6} lg={3}>
                <MaskInput 
                    name='num_tarjeta' 
                    label="Número cuenta/tarjeta" 
                    placeholder="XXXX XXXX XXXX 0000" 
                    // helperText="Colocar los 4 últimos dígitos de la tarjeta o cuenta"
                />
                {/* <Input
                    name="num_tarjeta"
                    label="Número cuenta/tarjeta"
