...
const Breadcrumbs = ({
  ...
  if (main && main.type === 'collapse') {
    CollapseIcon = main.icon ? main.icon : MdAccountTree
    mainContent = (
  ...
  if (item && item.type === 'item') {
    ...
    ItemIcon = item.icon ? item.icon : MdAccountTree
    itemContent = (
      <Typography
        variant='subtitle1'
        sx={{
              ...
              <Grid item>
                ...
                >
                  <Typography
                    ...
                    sx={linkSX}
                  >
                    {icons && <AiFillHome sx={iconStyle} />}
                    {icon && <AiFillHome sx={{ ...iconStyle, mr: 0 }} />}
                    {!icon && 'Dashboard'}
                  </Typography>
                  {mainContent}
                  {itemContent}
