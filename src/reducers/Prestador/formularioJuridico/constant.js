...
export const SET_EST_REPRESENTANTE = "@formulario/SET_EST_REPRESENTANTE";
...
export const SET_EST_PRESTADOR = "@formulario/SET_EST_PRESTADOR";
export const SET_GRAN_CONTRIB = "SET_GRAN_CONTRIB";