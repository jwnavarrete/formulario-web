...
const formularioNaturalReducer = (state = initialState, action) => {
  const isLastStep = () => {
  ...
  switch (action.type) {
    ...
    case actionTypes.SET_EST_SOLICITANTE:
      return {
        ...state,
        solicitante: action.solicitante,
      };
...
export default formularioNaturalReducer;
